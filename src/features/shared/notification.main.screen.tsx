      ...
      >
        <VStack style={[s.Widget]}>
          <Box style={[s.Widget_item]}>
            ...
            <Text style={[s.generic_text_lg]}>Notification1</Text>
          </Box>
          <Box style={[s.Widget_item]}>
            <Ionicons name="warning" color="white" size={25} />
            <Text style={[s.generic_text_lg]}>Alert Notification</Text>
          </Box>
          <Box style={[s.Widget_item]}>
            <Ionicons name="pricetags-outline" color="white" size={25} />
            <Text style={[s.generic_text_lg]}>Payment Status Notification</Text>
          </Box>
          <Box style={[s.Widget_item]}>
          ...
          <Box style={[s.Widget_item]}>
            ...
            <Text style={[s.generic_text_lg]}>Update Notification</Text>
          </Box>
        </VStack>
      </VStack>
    </StaticScreenWrapper>
