...
import {Alert, Box, HStack, VStack, Heading, Button as ButtonRN, FormControl, Input, InputField, Pressable} from '@gluestack-ui/themed'
...
const ParentsManagement = ()=> {
  ...
  const fetchUsers = async ()=>{
    try{
      const result = await api.tenant.all();
  ...
  const handleDeleteUser = async (userId: string|number) => {
    ...
    try{
      const result = await api.tenant.delete(selectedUser.id);
      fetchUsers();
  ...
  const [addUserForm, setAddUserForm] = useState<AddUserProps>({
    username: "",
    firstname: "",
    lastname: "",
    email: "",
  ...
  const handleAddUser = async () => {
    ...
    if (addUserForm?.password.length < 6) {
      AlertRN.alert('Invalid Password', 'Password must be at least 6 characters');
      return 
    }
     try{
      const result = await api.tenant.create(addUserForm);
      fetchUsers();
      AlertRN.alert('Accound updated!');
      setAddUserForm({
        username: "",
              ...
              <FormControl>
                ...
                <Input>
                  <InputField 
                    ...
                    onChangeText={(text: string)=>setEditForm({...editForm, age: text})}
                    style={[s.FormTextInput]}
                  />
                </Input>
              </FormControl>
              <FormControl>
                ...
                <Input>
                  <InputField 
                    ...
                    onChangeText={(text: string)=>setEditForm({...editForm, phone_number: text})}
                    style={[s.FormTextInput]}
                  />
                </Input>
              </FormControl>
              ...
              <FormControl>
                ...
                <Input>
                  <InputField 
                    ...
                    onChangeText={(text: string)=>setEditForm({...editForm, guardian: text})}
                    style={[s.FormTextInput]}
                  />
                </Input>
              </FormControl>
...
{/* -----------------Add Owner ------------------------------------------------------------------------------------------------------------ */}
      <Button 
        variant='primary'
        onPressAction={()=>{setAddUserModal(true);}} 
        containerStyle={{
          position: 'absolute',
          bottom: 25,
          right: 25,
          ...
          <Alert
            ...
            >
              ...
              >
                ...
                <Heading>
                  <Text style={[s.Text, {fontSize: Fontsize.h1}]}>Add Tenant</Text>
                </Heading>
                <ScrollView>
                  <FormControl>
                    <FormControl.Label>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, username: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, password: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, firstname: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, lastname: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, email: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, age: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, phone_number: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, address: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
                  <FormControl>
                    ...
                    <Input>
                      <InputField 
                        ...
                        onChangeText={(text: string)=>setAddUserForm({...addUserForm, guardian: text})}
                        style={[s.FormTextInput]}
                      />
                    </Input>
                  </FormControl>
